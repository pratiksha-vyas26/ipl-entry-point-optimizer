...
import { UserCheck, ShieldAlert, Award, Filter, ChevronRight } from 'lucide-react';
...
export const OversChart: React.FC<OversChartProps> = ({
  ...
  // Default to 'middle' (overs 7-15) as required by prompt
  ...
  // Filter overs according to selected phase
  ...
  // All unique bowlers faced by this batsman across all overs
  ...
  // Highlight Green Zone specifically
  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 sm:p-5 backdrop-blur-sm space-y-5">
      ...
      {/* OVER INSPECTOR: Summary of selected over */}
      {selectedOverStat && (
        <div className="rounded-xl border border-slate-800/90 bg-slate-950/80 p-4 space-y-4">
          ...
          {/* Key metrics grid for this over */}
          ...
          {/* BOWLERS FACED IN THIS OVER - Particular Stats */}
          <div className="pt-2">
